...
class APIService {
  ...
  startDataCollection = (config) => {
    return this.request('/data-collection/start', {
      method: 'POST',
  ...
  // Preprocessing APIs
  startPreprocessing = (config) => {
    return this.request('/preprocessing/start', {
      method: 'POST',
      body: JSON.stringify(config),
    });
  };
  ...
  // Tokenization APIs
  trainTokenizer = (config) => {
    return this.request('/tokenization/train', {
      method: 'POST',
      body: JSON.stringify(config),
    });
  };
  ...
  // Fine-tuning APIs
  startFinetuning = (config) => {
    return this.request('/finetuning/start', {
      method: 'POST',
      body: JSON.stringify(config),
    });
  };
